        ...
        <div className=" px-5 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-[2fr_2fr_1fr] gap-8 mb-5">
            ...
            <div className="flex justify-start md:justify-center md:mt-5">
              <div className="">
                <h5 className=" text-xl md:text-2xl  mb-2 md:mb-4">
                  STAY UPDATED
                </h5>
                <p>
                  Subscribe to our newsletter for camping inspiration and
                  special offers
                </p>
                <div className="flex mt-2">
                  <input
                    ...
                    className="border bg-white px-3 py-2 placeholder:text-gray-400 border-gray-300 rounded-l"
                  />
                  <span className="bg-orange-400 py-2 px-4 flex items-center rounded-r text-white">
                    <FaArrowRight />
                  </span>
                </div>
              </div>
          ...
          <p className="text-gray-300 text-sm mt-5 text-center">
            © 2025 CampFind All rights reserved | CampFind is created with ❤️
